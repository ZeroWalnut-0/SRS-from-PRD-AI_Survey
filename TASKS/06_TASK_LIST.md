# 📋 개발 태스크 목록 명세서 (Task Breakdown from SRS_v1)
...
| **Step 2** | Quota Management (FE) | 2 | 2H / 0M / 0L |
| **Step 2** | Panel Routing (BE+FE) | 4 | 2H / 2M / 0L |
| **Step 2** | Rate Limit & Auth | 3 | 2H / 0M / 1L |
| **Step 2** | Data Retention | 2 | 1H / 1M / 0L |
| **Step 3** | 테스트 (전체) | 26 | 4H / 18M / 4L |
| **Step 4** | NFR (성능/보안/모니터링/인프라/비용/Fallback) | 23 | 5H / 12M / 6L |
| | **합계** | **141** | **30H / 70M / 41L** |
